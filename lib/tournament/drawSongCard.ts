import { BADGE_RADIUS, BASE_CARD_HEIGHT, BASE_CARD_WIDTH, CARD_BORDER_RADIUS, CARD_FONT_FAMILY, JACKET_BASE_SIZE, JACKET_RADIUS } from "../constant/card"
...
export function drawSongCard(
  ...
  if (options.titleMode === "scroll" && typeof options.titleOffsetX === "number") {
